...
void neighborAvgMovement(float** VxM, float** VyM, float** vx, 
						float** vy, int len, int width) {
  int i,j;
...
void compareTwoImgs(float** img1, float** img2, float** Ix, 
			float** Iy, float** It, int len, int width) {
  int i,j;
...
// jacobi iteration
void jacobi(float** OptFl_Vx, float** OptFl_Vy, float** VxM, 
			float** VyM, float** Ix, float** Iy, float** It, 
